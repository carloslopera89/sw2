...
public class Ordenes_Compra {
    ...
    public Ordenes_Compra(int numero_orden, String fechaSalida, String horaSalida , String fechaLLegada, 
            String horaLLegada, int ciudadOrigen, int ciudadDestino, int cantidad, String cliente, 
